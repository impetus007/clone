...
import "./ad_lib.css";
function School_Admin_Library_Chapter_Progress(chapterDetails) {
  const [moduleOpen, setModuleOpen] = useState(-1);

  return (
    <div className="ad-lib-chapter-progress">
...
export default School_Admin_Library_Chapter_Progress;
